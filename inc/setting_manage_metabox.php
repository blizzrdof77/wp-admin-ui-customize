						...
						<div class="postbox">
							...
							<div class="inside">
								...
								<?php if( empty( $Metaboxes["metaboxes"]["post"] ) ) : ?>
									...
									<?php $edit_link = self_admin_url( 'post.php?post=' . $post[0]->ID . '&action=edit' ); ?>
									<?php $edit_link_name = __( 'Edit Post'); ?>
					
									<p><?php echo sprintf( __( 'Could not read the columns. Please load the %s.', $this->ltd ) , $edit_link_name ); ?></p>
									<p>
										<a href="<?php echo $edit_link; ?>" id="column_load" class="button button-primary">
											<?php echo sprintf( __( 'Load the %s', $this->ltd ) , $edit_link_name ); ?>
										</a>
									</p>
						...
						<div class="postbox">
							...
							<div class="inside">
								...
								<?php if( empty( $Metaboxes["metaboxes"]["page"] ) ) : ?>
									...
									<?php $edit_link = self_admin_url( 'post.php?post=' . $post[0]->ID . '&action=edit' ); ?>
									<?php $edit_link_name = __( 'Edit Page'); ?>
